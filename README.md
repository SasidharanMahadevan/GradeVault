...
A console-based Student Result Management System built in Java, designed to manage student records with full CRUD functionality, ranking, and persistent storage backed by a MySQL database.
